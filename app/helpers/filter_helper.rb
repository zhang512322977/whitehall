...
module FilterHelper
  ...
  def topic_options_for_statistics_announcement_filter(selected_slug = nil)
    options_for_select(PolicyArea.with_statistics_announcements.alphabetical.map { |topic| [topic.name, topic.slug] }.unshift(['All policy areas', nil]), Array(selected_slug))
  end
