class ClassificationRelation < ActiveRecord::Base
  ...
  belongs_to :topic, foreign_key: :classification_id, class_name: "PolicyArea"
  belongs_to :related_topic, foreign_key: :related_classification_id, class_name: "PolicyArea"
